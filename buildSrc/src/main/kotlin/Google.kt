...
object Google {
	...
	private const val versionAuth = "20.2.0"
	private const val versionClient = "1.34.1"
	private const val versionJetty = "1.33.3"
	private const val versionDrive = "v3-rev197-1.25.0"
	private const val versionGson = "2.9.0"
	...
	object Lib {
		...
		const val clientJetty = "$lib.oauth-client:google-oauth-client-jetty:$versionJetty"
